...
export function ShadcnLogo({ className, size = 24 }: ShadcnLogoProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" className={cn(className)} width={size} height={size}>
